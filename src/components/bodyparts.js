  ...
  return (
    <Tabs className='muscle-tabs'>
      <TabList className='tabs'>
        <Tab className='tabs-item' onClick={() => setMuscle('biceps')}>
          Biceps
        </Tab>
        <Tab className='tabs-item' onClick={() => setMuscle('triceps')}>
          Triceps
        </Tab>
        <Tab className='tabs-item' onClick={() => setMuscle('middle_back')}>
          Back
        </Tab>
        <Tab className='tabs-item' onClick={() => setMuscle('chest')}>
          Chest
        </Tab>
        <Tab className='tabs-item' onClick={() => setMuscle('hamstrings')}>
          Legs
        </Tab>
      </TabList>
